...
#Movimiento que se va a realizar al hacer click en dos casillas
mueveme = ""

#Variable que guarda todas las jugadas
listaJugadas = []
...
#Ventana Gtk.WindowType.TOPLEVEL, Gtk.WindowType.POPUP 
win = Gtk.Window(title = "Damas - Python", name = "Ventana")
ancho = 640
alto = 640
