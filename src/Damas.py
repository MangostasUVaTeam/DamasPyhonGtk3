...
def entradaPermitida(movimiento):
    ...
    try:
        ...
        if ((tablero[c1][c2].color == 0) and (turno == "Blancas")) or (
                    (tablero[c1][c2].color == 1) and (turno == "Negras")):
            ...
            for y in range(1, -2, -2):
                ...
                for i in posibles:
                    ...
                    for r in i:
                        ...
                        if (turnoColor == 1 and r[0] == "1") or (turnoColor == 0 and r[0] == "6") or (
                                    tablero[c3][c4].tipo == 1):
                            ...
                            for j in range(5):
                                ...
                                try:
                                    if tableroPosibles[valor1 + x + superX][valor2 + y + superY] != 0 and tablero[c3][
                                        c4].color == tableroPosibles[valor1 + x + superX][valor2 + y + superY].color:
                                        break
                                except IndexError:
                                    break
...
def addPosibles(valor1, valor2, x, y, lista, posibles, superX, superY, tableroPosibles):
    if (valor1 >= 0) and (valor2 >= 0):
        ...
        try:
            ...
            if (tableroPosibles[valor1 + x + superX][valor2 + y + superY] != 0) and (
                        tableroPosibles[valor1 + (2 * x + superX)][valor2 + (2 * y + superY)] == 0) and (
                        tableroPosibles[valor1 + x + superX][valor2 + y + superY].color != turnoColor):
...
while seguir == True:
    ...
    if entradaPermitida(movimiento) == True:
        ...
        if numFichas(turnoColor) == 0:
            ...
            verTablero()
            print(
                "  Enhorabuena! Las " + turno + " ganan la partida, el jugador contrario se ha quedado sin fichas. \n")
